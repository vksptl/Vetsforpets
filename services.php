...
<body>
    ...
    <div class="inner-header inhdcolor3">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="service-box-in">
                        <div class="service-box-tit ">
                            <h2 class="service-box-tit-text">
                                Book An Appointment</h2>
                        </div>
                        <div class="service-box-desc">
                            Get your pet checked up by booking an appointment with a highly classified veterinarian.
                        </div>
                        <div class="service-box-btn-pn ">
                ...
                <div class="col-sm-4">
                    <div class="service-box-in">
                        ...
                        <div class="service-box-desc">
                            Confused where to go and what type of vet to look for? Read our blogs for more information.
                        </div>
                        <div class="service-box-btn-pn ">
                            <a href="doglib.php" class="home-box-button ">GO → </a>
                        </div>
                    </div>
                </div>
            </div>
