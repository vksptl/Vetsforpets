        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <br clear="all" />
                    <br />
                    <div class="col-sm-6 feedbackbox">
                        <textarea class="textfield" type="text" rows="6" id="note" placeholder="Your Feedback Here"></textarea>
                        <div class="feedbackbox-btnbox">
                            <a href="#" class="home-box-button">vetsforpets@gmail.co</a>
                        </div>
                    </div>
                </div>
            </div>
